...
# ============================================================================
# STEP 4A: CREATE SUBTITLE WITH COUNTRY CONTEXT AND WTP INTERPRETATION
# ============================================================================
#
# HEALTH ECONOMIC PURPOSE:
# -----------------------------------------------------------------------------
# The subtitle provides critical context for interpreting the tornado plot:
# 1. COUNTRY IDENTIFICATION: Reminds readers which country's analysis is shown
# 2. COST-EFFECTIVENESS CONCLUSION: Indicates whether the intervention is
#    cost-effective across all parameter variations
#
# INTERPRETATION:
# -----------------------------------------------------------------------------
# "All usual willingness-to-pay thresholds are exceeded in all variations"
# means that the ICER remains above typical WTP thresholds regardless of
# which parameter is varied. This indicates the intervention is NOT
# cost-effective under standard decision rules, and this conclusion is
# ROBUST to parameter uncertainty.
#
# This is a key finding because it shows that no single parameter change
# (within plausible ranges) would make the intervention cost-effective.

# Create informative subtitle with country and WTP interpretation
# -----------------------------------------------------------------
...
# --------------------------------------------
# This code performs four operations (chained with +):
#
# 1. ggtitle(plot_title): Adds the main title
#
# 2. labs(subtitle = plot_subtitle): Adds the subtitle below the title
#    - subtitle: parameter for adding explanatory text below the title
#    - Automatically formatted smaller than the main title
#
# 3. theme(plot.title = element_text(hjust = 0.5)): Centers the title
...
#
# 4. theme(plot.subtitle = element_text(hjust = 0.5)): Centers the subtitle
#    - plot.subtitle: selects the subtitle element
#    - hjust = 0.5: centers the subtitle to align with the centered title
#
# 5. theme(axis.title.y = element_text(vjust = 0.25)): Adjusts y-axis label
...
#
# Health economic value: Professional presentation with clear interpretation
# enhances credibility and ensures decision-makers understand the robustness
# of the cost-effectiveness conclusion
...
# Create identical subtitle for consistency
# -------------------------------------------
# Use the same subtitle as the limited version to ensure both plots
# communicate the same key finding about cost-effectiveness robustness
plot_subtitle <- paste0(
  country_name[1],
  ": All usual willingness-to-pay thresholds are exceeded in all variations"
)

# Apply identical formatting (centered title, subtitle, and adjusted axis label)
# -------------------------------------------------------------------------------
...
# Both plots should communicate the same interpretation via the subtitle.
